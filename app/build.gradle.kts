...
android {
    namespace = "com.quanghuy2309.pureroot"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.quanghuy2309.pureroot"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // ViewModel
    implementation("androidx.lifecycle:lifecycle-viewmodel-ktx:2.7.0") // Kiểm tra version mới nhất
